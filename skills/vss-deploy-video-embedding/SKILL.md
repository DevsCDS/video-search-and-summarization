...
4. The host environment must provide, at minimum, `RTVI_EMBED_PORT`, `VSS_DATA_DIR`, and `NGC_API_KEY`; optionally set `HF_TOKEN` to avoid Hugging Face 429 rate-limit errors during the Cosmos-Embed1 weights download.
